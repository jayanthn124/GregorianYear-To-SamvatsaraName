...
if year_of_samvatsara == 0:
    ...
    print("\n Number of Years from the Start of REF Cycle (54 BCE) is = ", abs(num_of_years))
    ...
    if year_of_samvatsara >= start_of_ref_cycle and year_of_samvatsara <= end_of_ref_cycle:
        # Start and End of the Samvatsara Cycle:
        print("\n The Start of the Samvatsara Cycle is: ", start_of_ref_cycle)
        print("\n The End of the Samvatsara Cycle is: ", end_of_ref_cycle)
        # Samvatsara Index Calculation:
        if year_of_samvatsara > 0:
